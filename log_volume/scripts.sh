python cal_log_volume.py \
  ...
  --out /home/ethanrao/MIA_LDM/ldm_light/log_volume/logvols_mnist_beta_1e_2.npz \
  --device cuda \
  --batch-size 32 \
  --k 50 \
  --n-iter 30
...
python cal_log_volume.py \
  ...
  --dataset-root /home/ethanrao/MIA_LDM/data \
  --out /home/ethanrao/MIA_LDM/ldm_light/log_volume/logvols_cifar10_beta_1e_2.npz \
  --device cuda \
  --batch-size 32 \
  --k 50 \
  --n-iter 30
...
python attack.py \
  ...
  --logvol /home/ethanrao/MIA_LDM/ldm_light/log_volume/logvols_cifar10_beta_1e_2.npz \
  --device cuda \
  --grouping median \
  --batch-size 64
