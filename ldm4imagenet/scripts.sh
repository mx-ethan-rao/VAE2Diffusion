...
# python attack.py --data_root /data/mingxing/IMNET100K/ --out_dir /data/mingxing/tmp/IMNET100K/runs/ldm_imnet256_10k --amp
...
python attack_by_group_advance.py \
  --data_root /data/mingxing/IMNET100K/ \
  --out_dir /data/mingxing/tmp/IMNET100K/runs/ldm_imnet256_10k \
  --pullback_npz /data/mingxing/tmp/IMNET100K/runs/ldm_imnet256_10k/imnetv1_10k_pullback.npz
...
python cal_per_dim_contri.py \
  ...
  --out_dir /data/mingxing/tmp/IMNET100K/runs/ldm_imnet256_10k \
  --pullback_npz /data/mingxing/tmp/IMNET100K/runs/ldm_imnet256_10k/imnetv1_10k_pullback.npz \
  --out_npz /data/mingxing/tmp/IMNET100K/runs/ldm_imnet256_10k/imnetv1_10k_per_dim.npz

python attack_per_dim.py \
  --data_root /data/mingxing/tmp/IMNET100K/data \
  --out_dir /data/mingxing/tmp/IMNET100K/runs/ldm_imnet256_10k \
  --pullback_npz /data/mingxing/tmp/IMNET100K/runs/ldm_imnet256_10k/imnetv1_10k_pullback.npz \
  --perdim_npz /data/mingxing/tmp/IMNET100K/runs/ldm_imnet256_10k/imnetv1_10k_per_dim.npz
